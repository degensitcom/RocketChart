...
def scale_ohlc_data(data, scale_factor, round_factor=2):
    """
    ...
    for item in data:
        ...
        scaled_ohlc = [round(value * scale_factor, round_factor) for value in ohlc_values]
...
class CustomCandlestick:
    def __init__(self, data, width=0.4):
        self.data = data
        self.graphic = 'triangle'
        self.width = width
